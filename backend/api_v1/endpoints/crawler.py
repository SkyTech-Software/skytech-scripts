...
from backend.schema.crawler import CrawlerInputLinks
...
# TODO: zip_file = your code
# TODO: import CrawlerInputKeyword
# return send_mail(target_email=crawler_input.target_email, subject="Fonts Extractor", message="Please find attached .zip file.", file_content=zip_file, file_content_type="zip", file_name="Fonts.zip")
